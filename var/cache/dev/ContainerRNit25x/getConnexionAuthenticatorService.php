...
return $this->privates['App\\Security\\ConnexionAuthenticator'] = new \App\Security\ConnexionAuthenticator(($this->services['knpu.oauth2.registry'] ?? ($this->services['knpu.oauth2.registry'] = new \KnpU\OAuth2ClientBundle\Client\ClientRegistry($this, ['facebook' => 'knpu.oauth2.client.facebook']))), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->load('getDoctrine_Orm_DefaultEntityManagerService.php')), ($this->privates['App\\Repository\\UserRepository'] ?? $this->load('getUserRepositoryService.php')));
